    ...
    <div className="min-h-screen bg-neutral-50 antialiased text-gray-900">
      ...
      <header className="relative">
        <div className="relative z-0">
          {" "}
          {/* hero base z-0 so overlays and content sit below floating panel */}
          ...
          <section className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            ...
            {project.shortText ? (
              ...
              <p className="text-gray-600">
                No overview provided for this project.
              </p>
            )}
          </section>
          ...
          <div className="sticky top-28 space-y-6">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-white to-white/95 border border-gray-100 p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Interested in a similar design? Tell us about your brief and
                timeline — we'll follow up.
              </p>

              <Link
                href="/get-quote"
                className="mt-4 inline-flex items-center justify-center w-full rounded-lg bg-amber-400 hover:bg-amber-500 text-black py-3 font-semibold transition"
              >
                Get a Quote
              </Link>
              ...
              <div className="mt-4 flex gap-3">
                <a
                  href={`mailto:hello@epixinfra.com?subject=Project inquiry - ${encodeURIComponent(
          ...
          >
            ...
            >
              ...
              <div className="relative w-full aspect-[16/10] bg-black">
                <Image
                  src={urlFor(gallery[lightboxIndex])
                    .width(2000)
                    .height(1400)
                    .url()}
                  alt={
                    gallery[lightboxIndex]?.alt || `Image ${lightboxIndex + 1}`
                  }
                  fill
              ...
              <div className="flex items-center justify-between gap-4 p-4 bg-white/95">
                ...
                <a
                  ...
                  href={urlFor(gallery[lightboxIndex])
                    .width(3000)
                    .height(2000)
                    .url()}
                  target="_blank"
